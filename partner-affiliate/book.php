<?php
// File: /home/dbfa8e5/reimaginetours.com/wp-content/themes/traveler-childtheme/partner-affiliate/book.php (your exact original backend code, with PBP_Utils line added)

// Add the line for PBP_Utils (adjust path if the file is not in partner-affiliate)
require_once get_stylesheet_directory() . '/partner-affiliate/class-pbp-utils.php';

// Test message for loading (remove after testing)
echo '<div style="padding:20px;background:#2ecc71;color:#fff;">✅ book.php loaded successfully with full functionality.</div>';

// Your original code pasted exactly below
...
<div class="book">
    <h2 class="st-book-heading"><?php esc_html_e('Book Dashboard', 'partner-portal'); ?></h2>
    <p class="st-book-subtext"><?php esc_html_e('Welcome affiliate partner. Book', 'partner-portal'); ?></p>

    <div class="affiliate-book-content">
        <h3>Affiliate Book Section</h3>
        <div style="padding:20px;background:#2ecc71;color:#fff;">✅ book.php loaded successfully.</div>
    </div>

    <div class="st-affiliate-footer">
        <?php esc_html_e('Book Dashboard', 'partner-portal'); ?>
    </div>
</div>
