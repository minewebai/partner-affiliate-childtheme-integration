...
<a href="https://reimaginetours.com" target="_blank">
    <img src="https://reimaginetours.com/wp-content/uploads/2020/04/reimagine-experiences-tours-wuerzburg-eu.fw_.png" 
...
if (in_array('partner', $roles) && $partner_type === 'affiliate') {
        ...
        echo '<p style="color: blue;">Temporary: Detected SC value = ' . esc_html($current_sc) . '</p>'; // Debug: Shows detected SC

        if ($current_sc === 'pbp_dashboard' || $current_sc === '') {
            echo '<p style="color: blue;">Temporary: Entered DASHBOARD branch</p>'; // Debug
            include $affiliate_dir . 'affiliate-dashboard.php';
        } else if ($current_sc === 'pbp_book') {
            echo '<p style="color: blue;">Temporary: Entered BOOK branch</p>'; // Debug
            include $affiliate_dir . 'book.php';
        } else if ($current_sc === 'pbp_bookings') {
            echo '<p style="color: blue;">Temporary: Entered BOOKINGS branch</p>'; // Debug
            include $affiliate_dir . 'bookings.php';
        } else if ($current_sc === 'pbp_commissions') {
            echo '<p style="color: blue;">Temporary: Entered COMMISSIONS branch</p>'; // Debug
            include $affiliate_dir . 'commissions.php';
        } else if ($current_sc === 'pbp_account') {
            echo '<p style="color: blue;">Temporary: Entered ACCOUNT branch</p>'; // Debug
            include $affiliate_dir . 'account.php';
        } else {
            echo '<p style="color: blue;">Temporary: Entered FALLBACK branch (invalid SC)</p>'; // Debug
            include $affiliate_dir . 'affiliate-dashboard.php';
        }
